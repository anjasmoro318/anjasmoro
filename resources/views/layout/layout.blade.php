...
<body class="homepage">
   ...
   <header id="main-header">
   	...
   	<div class="row header-inner">
	      ...
	      <div class="logo">
	         <a class="smoothscroll" href="#hero">ANJASMORO</a>
	      </div>
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            <li class="current"><a class="smoothscroll" href="#hero">@section('sidebar')</a></li>
		         <li><a class="smoothscroll" href="#portfolio">HTML</a></li>
	            <li><a class="smoothscroll" href="#services">CSS</a></li>
	            <li><a class="smoothscroll" href="#about">JS</a></li>
	            <li><a class="smoothscroll" href="#journal">@show</a></li>	            
				<ul>
